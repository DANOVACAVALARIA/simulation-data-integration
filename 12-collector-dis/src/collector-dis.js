...
//   // handle WS messages
//   socket.on('dis-message', (msg) => {
//     console.log(`COLLECTOR-DIS => received message with ${msg.length} bytes.`)
//     pduBufferArray.push(msg)
//     pduCount++
//     session.pdus = pduCount
//     totalKB += msg.length
//     session.totalKB = totalKB
...
//     console.log(`COLLECTOR-DIS => connection with ${socket.handshake.address} ended.`)
...
//   console.log(`COLLECTOR-DIS => WS server started on port ${config.wsLocalPort}...`)
// })